...
"""
    try:
        ...
        print(f'DBiz GPT v{VERSION} - building the best AI user interface for your business.\nhttps://github.com/open-webui/open-webui')
...
async def get_manifest_json():
    ...
    if external_pwa_manifest_url:
        ...
        return {
            ...
            'description': f'{app.state.WEBUI_NAME} is a powerful, extensible AI interface tailored for your business workflow.',
            'start_url': '/',
            'display': 'standalone',
