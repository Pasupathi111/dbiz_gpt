...
<div class="flex flex-col h-full overflow-y-auto">
	<div class="px-4 sm:px-6 lg:px-8 pt-6 pb-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
		<div class="flex items-center gap-2 text-xs text-gray-400 dark:text-gray-500 mb-1">
			<span>AI SCS Copilot</span><span>/</span><span>Settings</span>
		</div>
				...
				<div class="px-4 sm:px-6 py-4 space-y-3">
					{#each [
						...
						<div class="flex items-center justify-between gap-4 py-2">
							...
							<button
								class="relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors {getter() ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-gray-700'}"
